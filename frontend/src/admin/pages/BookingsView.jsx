import { CalendarCheck2, Clock3, Eye, UserRoundCheck } from "lucide-react";
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[1060px] border-collapse">
            ...
            <thead className="bg-slate-50">
              <tr>{["Booking", "Renter", "Vehicle", "Operator", "Pickup", "Return", "Driver", "Status", "Actions"].map((heading) => <th key={heading} scope="col" className="border-b border-slate-200 px-4 py-3 text-left text-[11px] font-bold uppercase tracking-[0.1em] text-slate-600">{heading}</th>)}</tr>
            </thead>
